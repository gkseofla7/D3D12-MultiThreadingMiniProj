...
void D3D12HelloTriangle::LoadAssets()
{
     // RootSignature
    {
        ...
        CD3DX12_DESCRIPTOR_RANGE1 ranges2;
        ranges[0].Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 1, 0, 0, D3D12_DESCRIPTOR_RANGE_FLAG_DATA_STATIC);
        ranges[1].Init(D3D12_DESCRIPTOR_RANGE_TYPE_CBV, 1, 0, 0, D3D12_DESCRIPTOR_RANGE_FLAG_DATA_STATIC);

        CD3DX12_ROOT_PARAMETER1 rootParameters[1];
        rootParameters[0].InitAsDescriptorTable(_countof(ranges), ranges);
       // rootParameters[1].InitAsDescriptorTable(1, &ranges2, D3D12_SHADER_VISIBILITY_VERTEX);
...

    {
        ...
        CD3DX12_CPU_DESCRIPTOR_HANDLE cbvHandle(m_srvHeap->GetCPUDescriptorHandleForHeapStart(), 1, m_device->GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV));
